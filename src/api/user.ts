...
import { deleteDonorNumber, generateDonorNumber, getAdminDonor, getAdmins, getAdminSetting, getDonorNumber, getDonorSetting, loginAdmin, loginDonor, registerAdmin, registerDonor, updateDonorPassword, updateDonorSetting } from '../controller/userController';
